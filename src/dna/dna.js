...
const SEED_NODES = {
  ...
  principle: [
    ...
    seedN("n_pr_no_publish", "Never auto-publish or spam", 1.0,
      "Never auto-publish, auto-post, or auto-send, and never spam. Do not move a Short to posted, an article to published, or a creator forward in the pipeline on your own. Every send is a human decision.", { locked: true }),
  ...
  signal: [
    ...
    seedN("n_sg_stage", "Pipeline stage", 0.7,
      "Each creator moves prospected → drafted → sent → replied → collab. Read where a creator sits before acting: a prospected Prime needs a pitch, a replied creator needs a human response, a collab is already won."),
